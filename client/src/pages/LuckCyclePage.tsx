      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
          <h1 className="text-2xl font-bold text-cyan-300 flex items-center gap-2">
            <TrendingUp className="w-6 h-6" /> 大限流年
          </h1>
          <p className="text-white/40 text-sm mt-1">五年流年流月分析（紫微斗數式四化推算）</p>
        </motion.div>
        ...
        {!hasAccess ? (
          ...
          <div className="text-center py-12">
            <p className="text-white/30 text-sm">尚無流年資料，請先完善命格設定</p>
          </div>
        ) : (
          <motion.div
        ...
        >
          <h3 className="text-cyan-300 text-xs font-semibold mb-2">📅 關於大限流年</h3>
          <p className="text-white/40 text-xs leading-relaxed">
            大限流年採用紫微斗數式四化推算，結合你的本命四柱，計算未來五年每年的整體運勢走向與逐月流月能量。
            四化（化祿、化權、化科、化忌）入宮分析，揭示各年的機遇與挑戰。
          </p>
        </motion.div>
      </main>
    </div>
