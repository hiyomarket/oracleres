...
const NODE_COORDS: Record<string, [number, number]> = {
  ...
  // ── 迷霧城 NPC 據點（台北）──
  "npc-fogcity-1":   [25.0330, 121.5654],
  "npc-fogcity-2":   [25.0478, 121.5170],
  "npc-fogcity-3":   [25.0340, 121.5228],
  "npc-fogcity-4":   [25.0418, 121.5079],
  "npc-fogcity-5":   [25.0460, 121.5085],
  "npc-fogcity-6":   [25.0375, 121.5645],
  "npc-fogcity-7":   [25.0500, 121.5250],
  "npc-fogcity-8":   [25.0280, 121.5430],
  "npc-fogcity-9":   [25.0530, 121.5140],
  "npc-fogcity-10":  [25.0420, 121.5440],
  // ── 初界 NPC 據點（台灣各地）──
  "npc-realm1-11":   [25.0170, 121.5390],
  "npc-realm1-12":   [24.7960, 120.9967],
  "npc-realm1-13":   [24.1478, 120.6736],
  "npc-realm1-14":   [24.9870, 121.5760],
  "npc-realm1-15":   [24.8059, 121.7513],
  "npc-realm1-16":   [23.5565, 120.4390],
  "npc-realm1-17":   [23.0000, 120.2200],
  "npc-realm1-18":   [24.0833, 120.5400],
  "npc-realm1-19":   [23.4800, 120.4500],
  "npc-realm1-20":   [22.6273, 120.3014],
  // ── 中界 NPC 據點（海外）──
  "npc-realm2-21":   [35.3606, 138.7274],
  "npc-realm2-22":   [35.6762, 139.6503],
  "npc-realm2-23":   [37.5665, 126.9780],
  "npc-realm2-24":   [30.2741, 120.1551],
  "npc-realm2-25":   [29.5630, 106.5516],
  "npc-realm2-26":   [34.6937, 135.5023],
  "npc-realm2-27":   [36.2048, 138.2529],
  "npc-realm2-28":   [35.0116, 135.7681],
  "npc-realm2-29":   [37.5793, 126.9770],
  // ── 試煉之塔（瑞士）──
  "npc-tower-30":    [46.5197, 7.9597],
  // ── 碎影深淵（尼泊爾）──
  "npc-abyss-31":    [27.9881, 86.9250],
};
