...
export const gameCatalogAdminRouter = router({
  ...
  getAllMonsters: adminProcedure.query(async () => {
    ...
    return db.select({
      ...
      skillId1: gameMonsterCatalog.skillId1,
      skillId2: gameMonsterCatalog.skillId2,
      skillId3: gameMonsterCatalog.skillId3,
      description: gameMonsterCatalog.description,
      imageUrl: gameMonsterCatalog.imageUrl,
      race: gameMonsterCatalog.race,
      species: gameMonsterCatalog.species,
      aiLevel: gameMonsterCatalog.aiLevel,
      actionsPerTurn: gameMonsterCatalog.actionsPerTurn,
      resistWood: gameMonsterCatalog.resistWood,
      resistFire: gameMonsterCatalog.resistFire,
      resistEarth: gameMonsterCatalog.resistEarth,
      resistMetal: gameMonsterCatalog.resistMetal,
      resistWater: gameMonsterCatalog.resistWater,
