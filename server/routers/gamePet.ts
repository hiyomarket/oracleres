...
const petCatalogInput = z.object({
  ...
  baseMp: z.number().int().min(0).default(20),
  baseMagicDefense: z.number().int().min(0).default(5),
  baseHealPower: z.number().int().min(0).default(0),
  baseCritRate: z.number().min(0).max(100).default(5),
  baseCritDamage: z.number().min(0).max(500).default(150),
  linkedMonsterId: z.string().optional(),
