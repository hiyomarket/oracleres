...
export const MONSTERS: Monster[] = [
  ...
  { id: "wood-003", name: "山豬精", element: "wood", level: 5, hp: 100, attack: 18, defense: 10, speed: 8, expReward: 35, goldReward: [10, 20], dropItems: [{ itemId: "mat-wood-002", chance: 0.4 }, { itemId: "food-001", chance: 0.5 }], skills: ["野豬衝撞", "大地震踏"], description: "被木靈能量附身的野豬，力大無窮。", isBoss: false, race: "靈獸系" },
  { id: "wood-004", name: "古木守衛", element: "wood", level: 8, hp: 180, attack: 28, defense: 18, speed: 5, expReward: 65, goldReward: [18, 35], dropItems: [{ itemId: "mat-wood-003", chance: 0.35 }, { itemId: "equip-wood-001", chance: 0.05 }], skills: ["樹根束縛", "木甲強化", "枝葉颶風"], description: "千年古木孕育出的守衛，樹皮如鐵甲堅硬。", isBoss: false, race: "植物系" },
  { id: "wood-005", name: "森林蜘蛛王", element: "wood", level: 12, hp: 300, attack: 45, defense: 25, speed: 15, expReward: 120, goldReward: [30, 60], dropItems: [{ itemId: "mat-wood-004", chance: 0.4 }, { itemId: "mat-wood-005", chance: 0.25 }], skills: ["毒絲纏繞", "蛛網陷阱", "毒牙噬咬"], description: "森林深處的蜘蛛女王，毒液能腐蝕金屬。", isBoss: false, race: "蟲類系" },
  { id: "wood-006", name: "藤蔓巨人", element: "wood", level: 15, hp: 450, attack: 60, defense: 35, speed: 6, expReward: 180, goldReward: [45, 90], dropItems: [{ itemId: "mat-wood-006", chance: 0.3 }, { itemId: "equip-wood-002", chance: 0.08 }], skills: ["藤蔓鞭打", "生命汲取", "木靈再生"], description: "由無數藤蔓聚合而成的巨人，能自我修復。", isBoss: false, race: "植物系" },
  ...
  { id: "fire-002", name: "熔岩蜥蜴", element: "fire", level: 3, hp: 55, attack: 12, defense: 5, speed: 5, expReward: 20, goldReward: [5, 14], dropItems: [{ itemId: "mat-fire-002", chance: 0.45 }], skills: ["火焰噴吐", "熔岩護甲"], description: "皮膚如熔岩般龜裂，體溫極高的蜥蜴。", isBoss: false, race: "靈獸系" },
  ...
  { id: "fire-004", name: "火焰狼", element: "fire", level: 8, hp: 160, attack: 32, defense: 15, speed: 18, expReward: 70, goldReward: [20, 40], dropItems: [{ itemId: "mat-fire-004", chance: 0.35 }, { itemId: "equip-fire-001", chance: 0.04 }], skills: ["火焰衝刺", "嚎叫強化", "灼燒噬咬"], description: "全身燃燒著火焰的狼，奔跑時留下火痕。", isBoss: false, race: "靈獸系" },
  { id: "fire-005", name: "爆炎魔人", element: "fire", level: 12, hp: 280, attack: 50, defense: 20, speed: 12, expReward: 130, goldReward: [32, 65], dropItems: [{ itemId: "mat-fire-005", chance: 0.35 }], skills: ["爆炎拳擊", "火焰旋風", "自爆威脅"], description: "由純粹火靈能量凝聚而成的人形怪物。", isBoss: false, race: "人型系" },
  { id: "fire-006", name: "灼熱鳳凰", element: "fire", level: 16, hp: 500, attack: 75, defense: 30, speed: 22, expReward: 200, goldReward: [50, 100], dropItems: [{ itemId: "mat-fire-006", chance: 0.3 }, { itemId: "equip-fire-002", chance: 0.07 }], skills: ["鳳凰烈焰", "涅槃重生", "火雨降臨"], description: "在火山口翱翔的鳳凰，死後能從灰燼中重生。", isBoss: false, race: "妖化系" },
  ...
  { id: "earth-002", name: "石頭蟹", element: "earth", level: 3, hp: 80, attack: 8, defense: 15, speed: 3, expReward: 16, goldReward: [4, 10], dropItems: [{ itemId: "mat-earth-002", chance: 0.5 }], skills: ["石鉗夾擊", "縮殼防禦"], description: "外殼堅硬如石的螃蟹，正面攻擊幾乎無效。", isBoss: false, race: "靈獸系" },
  ...
  { id: "earth-004", name: "岩石巨人", element: "earth", level: 8, hp: 250, attack: 22, defense: 30, speed: 4, expReward: 60, goldReward: [15, 30], dropItems: [{ itemId: "mat-earth-004", chance: 0.35 }, { itemId: "equip-earth-001", chance: 0.04 }], skills: ["岩石投擲", "大地震踏", "岩壁防禦"], description: "由岩石構成的巨人，每一步都讓大地顫抖。", isBoss: false, race: "金屬系" },
  { id: "earth-005", name: "土靈農夫精", element: "earth", level: 10, hp: 200, attack: 30, defense: 25, speed: 8, expReward: 90, goldReward: [22, 45], dropItems: [{ itemId: "mat-earth-005", chance: 0.4 }, { itemId: "food-earth-001", chance: 0.5 }], skills: ["鋤頭重擊", "豐收詛咒", "土靈召喚"], description: "農田中的土靈精靈，守護著農作物不受侵害。", isBoss: false, race: "人型系" },
  { id: "earth-006", name: "黃土魔像", element: "earth", level: 14, hp: 400, attack: 45, defense: 45, speed: 5, expReward: 160, goldReward: [40, 80], dropItems: [{ itemId: "mat-earth-006", chance: 0.3 }, { itemId: "equip-earth-002", chance: 0.07 }], skills: ["魔像重拳", "土靈護甲", "大地束縛"], description: "由古代術士以土靈能量製造的魔像，無情無義。", isBoss: false, race: "金屬系" },
  ...
  { id: "metal-002", name: "銀色狼人", element: "metal", level: 4, hp: 70, attack: 14, defense: 10, speed: 12, expReward: 22, goldReward: [6, 15], dropItems: [{ itemId: "mat-metal-002", chance: 0.45 }], skills: ["銀爪撕裂", "月光嚎叫"], description: "在月光下變形的狼人，爪子鋒利如銀刃。", isBoss: false, race: "妖化系" },
  ...
  { id: "metal-004", name: "鋼鐵武士", element: "metal", level: 10, hp: 200, attack: 35, defense: 28, speed: 10, expReward: 80, goldReward: [20, 40], dropItems: [{ itemId: "mat-metal-005", chance: 0.35 }, { itemId: "equip-metal-001", chance: 0.05 }], skills: ["武士斬擊", "鋼鐵防禦", "劍氣波動"], description: "由金屬能量凝聚而成的武士，劍術精湛。", isBoss: false, race: "人型系" },
  { id: "metal-005", name: "金礦守衛", element: "metal", level: 13, hp: 320, attack: 48, defense: 35, speed: 8, expReward: 140, goldReward: [35, 70], dropItems: [{ itemId: "mat-metal-006", chance: 0.35 }, { itemId: "mat-metal-007", chance: 0.2 }], skills: ["礦石投擲", "金屬強化", "礦坑崩塌"], description: "守護金礦的怪物，身上嵌著金色礦石。", isBoss: false, race: "金屬系" },
  { id: "metal-006", name: "白虎幼獸", element: "metal", level: 17, hp: 550, attack: 78, defense: 42, speed: 20, expReward: 220, goldReward: [55, 110], dropItems: [{ itemId: "mat-metal-008", chance: 0.3 }, { itemId: "equip-metal-002", chance: 0.07 }], skills: ["白虎斬擊", "金屬爪擊", "虎嘯震天"], description: "傳說中白虎的幼獸，爪子能切割金屬。", isBoss: false, race: "靈獸系" },
  ...
  { id: "water-002", name: "河童", element: "water", level: 3, hp: 65, attack: 11, defense: 7, speed: 8, expReward: 19, goldReward: [5, 13], dropItems: [{ itemId: "mat-water-002", chance: 0.5 }, { itemId: "herb-water-001", chance: 0.35 }], skills: ["水流衝擊", "河底拉扯"], description: "棲居於河川的河童，頭頂有一碟水，若水乾則失去力量。", isBoss: false, race: "妖化系" },
  ...
  { id: "water-004", name: "深海魚人", element: "water", level: 8, hp: 170, attack: 28, defense: 16, speed: 14, expReward: 68, goldReward: [17, 35], dropItems: [{ itemId: "mat-water-005", chance: 0.35 }, { itemId: "equip-water-001", chance: 0.04 }], skills: ["魚叉投擲", "水流加速", "深海壓力"], description: "從深海爬上岸的魚人，能在水中快速移動。", isBoss: false, race: "水生系" },
  { id: "water-005", name: "海浪巨人", element: "water", level: 11, hp: 260, attack: 42, defense: 22, speed: 11, expReward: 110, goldReward: [28, 55], dropItems: [{ itemId: "mat-water-006", chance: 0.35 }], skills: ["海浪衝擊", "水靈吸收", "洪水氾濫"], description: "由海浪凝聚而成的巨人，能召喚洪水。", isBoss: false, race: "水生系" },
  { id: "water-006", name: "冰龍幼體", element: "water", level: 15, hp: 480, attack: 68, defense: 38, speed: 16, expReward: 190, goldReward: [48, 95], dropItems: [{ itemId: "mat-water-007", chance: 0.3 }, { itemId: "equip-water-002", chance: 0.07 }], skills: ["冰龍爪擊", "冰霜龍息", "冰封大地"], description: "棲居於高山冰川的龍幼體，呼出的氣息能結冰。", isBoss: false, race: "龍種系" },
